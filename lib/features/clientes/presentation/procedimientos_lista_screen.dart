...
class ProcedimientosListaScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<ProcedimientosListaScreen> createState() =>
      _ProcedimientosListaScreenState();
}

class _ProcedimientosListaScreenState
    extends ConsumerState<ProcedimientosListaScreen> {
    ...
    return Scaffold(
      ...
      body: ResponsiveContent(
        child: procedimientosAsync.when(
          ...
          error: (error, _) =>
              Center(child: Text('Error al cargar procedimientos: $error')),
          data: (procedimientos) {
                ...
                Padding(
                  ...
                  child: SegmentedButton<EstadoProcedimiento?>(
                    ...
                    segments: const [
                      ...
                      ButtonSegment(
                        value: EstadoProcedimiento.activo,
                        label: Text('Activo'),
                      ),
                      ButtonSegment(
                        value: EstadoProcedimiento.pendiente,
                        label: Text('Pendiente'),
                      ),
                      ButtonSegment(
                        value: EstadoProcedimiento.cerrado,
                        label: Text('Cerrado'),
                      ),
                    ],
                    selected: {_filtro},
